    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl border border-zinc-200 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-zinc-900">Database</p>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-zinc-900">Skills Table</p>
        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-zinc-900">Activity Logs</p>
      ...
      <div className="bg-white rounded-xl border border-zinc-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-zinc-200">
          <h2 className="font-semibold text-zinc-900">Database Tables</h2>
        </div>
      ...
      {/* File Paths */}
      <div className="bg-white rounded-xl border border-zinc-200 p-6">
        <h2 className="font-semibold text-zinc-900 mb-4">Skill Storage Paths</h2>
        <div className="space-y-3">
          <div>
            <p className="text-sm text-zinc-500">Global Skills Directory</p>
            <p className="font-mono text-zinc-900 bg-zinc-50 px-3 py-2 rounded">
              {status.globalSkillsPath}
            </p>
          </div>
          <div>
            <p className="text-sm text-zinc-500">Local Skills Directory</p>
            <p className="font-mono text-zinc-900 bg-zinc-50 px-3 py-2 rounded">
      ...
      {/* Environment Info */}
      <div className="bg-white rounded-xl border border-zinc-200 p-6">
        <h2 className="font-semibold text-zinc-900 mb-4">Environment</h2>
