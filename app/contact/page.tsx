      ...
      <main className="container-wide py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-sand-900 mb-4">Get in Touch</h1>
          ...
          {/* Contact Card */}
          <div className="bg-white rounded-2xl border border-sand-200 p-8 md:p-12 text-center">
            <div className="w-16 h-16 bg-breezy-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <EnvelopeIcon className="w-8 h-8 text-breezy-600" />
            </div>

            <h2 className="text-2xl font-bold text-sand-900 mb-4">Email Us</h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-breezy-500 text-white font-semibold rounded-lg hover:bg-breezy-600 transition-colors text-lg"
            >
            ...
            <div className="mt-8 pt-8 border-t border-sand-200">
              <h3 className="font-semibold text-sand-900 mb-3">Looking for support?</h3>
              <p className="text-sand-600 text-sm">
                If you&apos;re a subscriber and need help with your account, email us at{' '}
                <a href="mailto:support@breezybuild.com" className="text-breezy-600 hover:underline">
          ...
          <div className="text-center mt-8">
            <p className="text-sand-600">
              Check our{' '}
              <Link href="/pricing" className="text-breezy-600 hover:underline font-medium">
                Pricing FAQ
              </Link>{' '}
