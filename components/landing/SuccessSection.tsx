  ...
  return (
    <section id="success" className="min-h-screen flex items-center justify-center bg-gradient-hero">
      <div className="container-tight section-padding text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-zinc-900 mb-4 animate-slide-up">
          {SUCCESS.headline}
        </h1>

        {/* Subheadline */}
        <p className="text-lg text-zinc-600 mb-2 animate-slide-up animate-delay-100">
          {SUCCESS.subheadline}
        </p>

        {email && (
          <p className="text-primary-600 font-medium mb-10 animate-fade-in animate-delay-200">
            {email}
          </p>
        )}

        {/* Deliverables */}
        <div className="max-w-md mx-auto bg-white rounded-2xl border border-primary-100 p-6 shadow-warm animate-scale-in animate-delay-300">
